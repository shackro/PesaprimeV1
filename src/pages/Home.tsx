...
const Home = () => {
  ...
  return (
    <div className="mx-2 mb-16 lg:mb-4 flex-col items-center justify-content-center overflow-x-hidden">
      ...
      {/* Market Assets */}
      <div className="mt-6 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 text-white mb-6">
        <h3 className="text-xl font-bold mb-4 text-center">Live Market</h3>

        <Trading/>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {assets.map((asset) => (
            <div key={asset.id} className="bg-gray-700 rounded-lg p-3 hover:bg-gray-600 transition duration-200">
